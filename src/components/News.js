...
const News = ({cat}) => {
  ...
  const fetchNews = async () =>{
    await axios.get(
      cat ? `https://gnews.io/api/v4/top-headlines?category=${cat}&lang=en&country=in&max=10&apikey=d7f8e510a75fe9aa463deefc756c6749`
      
      : "https://gnews.io/api/v4/top-headlines?category=general&lang=en&country=in&max=10&apikey=d7f8e510a75fe9aa463deefc756c6749"
