        ...
        <header className="p-2 text-white bg-violet-700">
          <div className="container mx-auto flex flex-wrap flex-col md:flex-row items-center">
            <Link
              ...
              target={"_self"}
            >
              <span className="ml-2 text-3xl text-amber-400 font-bold">
                NewsVia API
              </span>
            </Link>
            <nav className="md:ml-auto flex flex-wrap items-center justify-center gap-3 text-l">
              <Link to="/general" className=" hover:scale-105 duration-[400ms]">
                General
              </Link>
              <Link
                to="/business"
                className=" hover:scale-105 duration-[400ms]"
              >
                Business
              </Link>
              <Link
              ...
              <Link to="/sports" className=" hover:scale-105 duration-[400ms]">
                Sports
              </Link>
              <Link to="/health" className=" hover:scale-105 duration-[400ms]">
                Health
              </Link>
              <Link to="/science" className=" hover:scale-105 duration-[400ms]">
                Science
              </Link>
              <Link
                to="/entertainment"
